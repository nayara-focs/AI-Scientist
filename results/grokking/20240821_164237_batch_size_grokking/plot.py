...
folders = ["run_1", "run_2", "run_3", "run_4"]
final_results = {}
results_info = {}
...
labels = {
    "run_1": "Small to Large Batch Size",
    "run_2": "Medium to Large Batch Size",
    "run_3": "Large to Small Batch Size",
    "run_4": "Small to Large Batch Size (Different Range)",
}
